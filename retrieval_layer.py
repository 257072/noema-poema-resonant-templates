...
with open('curated_poems/96_Heart_Supported_Mind_tokenised.json', 'r', encoding='utf-8') as f:
    heart_supported_mind_tokens = json.load(f)
poem_index["Heart Supported Mind"] = heart_supported_mind_tokens
